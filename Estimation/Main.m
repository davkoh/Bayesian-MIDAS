...
% Data file name
dat_file = 'MF_FAME_FULL.xlsx'; %%% put in data file name here
...
sur = 1;     % survey data: NOT AVAILABLE PUBLICLY
...
% TODO: if no indicators, throw error
...
Var_pubgroup = [];
Varq_pubgroup = [2];
Vars_pubgroup = [5;5;5;1;1;1;5];                                         % surveys: CBIs,PMIs, GfK
...
% Heatmap
model_file = 'Output/TREND_fixed_SV_OBS_fixed_SV_PRIOR_gigg_GIGGTYPE_hier_ag_TAIL_normal_TRANSFORM_almon/results.mat';
