%% RMFSE and CRPS prediction graphs for multiple models

% Define model file paths and names
model_files = { ...
...
% Save as PDF and FIG
% Adjust figure size and layout to avoid cutting off labels/legend
set(fig1, 'Units', 'normalized', 'Position', [0.1 0.1 0.8 0.7]);
t.TileSpacing = 'compact';
t.Padding = 'compact';
drawnow; % Ensure all graphics objects are rendered

% Use exportgraphics for better PDF output (R2020a+)
exportgraphics(fig1, fullfile('Figures', 'nowcast_eval.pdf'), 'ContentType', 'vector', 'BackgroundColor', 'white', 'Resolution', 300);

% Also save as .fig for editing
saveas(fig1, fullfile('Figures', 'nowcast_eval.fig'));