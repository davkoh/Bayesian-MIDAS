...
if pr  ==1,    Var_delay = [Var_delay; Varp_delay];  end
if mon ==1,   Var_delay = [Var_delay; Varm_delay];  end
if mort ==1,   Var_delay = [Var_delay; Varmt_delay]; end
if fin ==1,   Var_delay = [Var_delay; Varf_delay];  end
if ie  ==1,    Var_delay = [Var_delay; Vari_delay]; end
if vis ==1,   Var_delay = [Var_delay; Varv_delay];  end    
...
if pr  ==1,    Var_pubgroup = [Var_pubgroup; Varp_pubgroup];  end
if mon ==1,   Var_pubgroup = [Var_pubgroup; Varm_pubgroup];  end
if mort ==1,   Var_pubgroup = [Var_pubgroup; Varmt_pubgroup]; end
if fin ==1,   Var_pubgroup = [Var_pubgroup; Varf_pubgroup];  end
if ie  ==1,    Var_pubgroup = [Var_pubgroup; Vari_pubgroup]; end
if vis ==1,   Var_pubgroup = [Var_pubgroup; Varv_pubgroup];  end   
