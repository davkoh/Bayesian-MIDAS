function nowcast_eval_function_single(model_files)
...
exportgraphics(fig1, fullfile('Figures', 'nowcast_eval_singlemod.pdf'), 'ContentType', 'vector', 'BackgroundColor', 'white', 'Resolution', 300);
saveas(fig1, fullfile('Figures', 'nowcast_eval_singlemod.fig'));
