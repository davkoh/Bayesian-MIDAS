...
%
% Usage:
%   plotInclusionProbabilityMap('Output/TREND_PC_OBS_PC_PRIOR_gigg_GIGGTYPE_fixed_TAIL_normal_TRANSFORM_almon/results.mat', 'Figures')
%
% Inputs:
%   resultsFile - Path to the .mat file containing the results (string)
%   figuresDir  - Directory to save the figures (string)
