...
[h,iOh,h0,omegah,Vomegah,Vh0] = h_samp(Y,tau,X,beta,lam,h_tilde,h0,omegah,a0_h,b0_h,Vomegah,Vh0,T,sv_ind);
...
[g,g0,omegag,Vomegag,Vg0] = g_samp(tau,tau0,g_tilde,g0,omegag,a0_g,b0_g,Vomegag,Vg0);
...
for j = 1:G
    ...
    end_tmp = grp_size_cs(j);
        ...
        % Draw ag
    a(j) = sample_ag_slice(a(j),gamma_sq(j),0,1,1,3);
...
%% Sample g
function [g,g0,omegag,Vomegag,Vg0] = g_samp(tau,tau0,g_tilde,g0,omegag,a0_g,b0_g,Vomegag,Vg0)
