...
cd 'D:\Downloads\GIGG-Nowcast-Output'
...
old = load('C:\Users\dkohn\OneDrive - Heriot-Watt University\Education\BoE Nowcasting Project 2022\Estimation\Output\output_bsts_sv_t_low_wlags_noinfl')
...
load('output_hst_sw_corrected_0.020833_0.5_almon_ortho_groupsparse.mat')
hs_sw_svt = output;
hs_sw_svt.incl([1:5 end],:,:) = [];

load('output_hs_sw_corrected_0.020833_0.5_almon_ortho_groupsparse.mat')
hs_sw_sv = output;
...
forecastdate = d_q; 
y = output.y;
savedir = 'D:\Downloads\graphs gigg application\';
...
%% Find Grouping
T2 = readtable('C:\Users\dkohn\OneDrive - Heriot-Watt University\Education\BoE Nowcasting Project 2022\Estimation\Data\publication_calendar_final_final.xlsx','Sheet','Variables');
