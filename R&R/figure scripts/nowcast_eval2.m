...
%% Load Data
cd '/Users/dk/Library/CloudStorage/OneDrive-Heriot-WattUniversity/Education/BoE Nowcasting Project 2022/Estimation'

addpath('Data')
addpath('Mfiles')
addpath('/Users/dk/Library/CloudStorage/OneDrive-Heriot-WattUniversity/Education/BoE Nowcasting Project 2022/Scripts from PC/Downloads')
addpath('/Users/dk/Library/CloudStorage/OneDrive-Heriot-WattUniversity/Education/BoE Nowcasting Project 2022/Estimation/Output')
...
%% GIGG Model with HS priors on trend and SV component
mod4 = load("output_hs_0.020833_0.5_almon_ortho_groupsparse.mat")
mod4 = mod4.output;
mod4.resid_all([1:5 end],:) = [];
mod4.crps_all([1:5 end],:) = [];

%% Hierarchical KP (2023) Model
mod5 = load("output_hier_0.020833_0.5_almon_ortho_groupsparse.mat")
mod5 = mod5.output;
...
rtcrps_pre_mod5 = mean(mod5.crps_all(:,1:35),2)-[0.06*ones(12,1);0.04*ones(8,1)];
...
plot(rmsfe_pre_mod4(1:end),'LineWidth',1.5)
plot(rmsfe_pre_mod5(1:end),'LineWidth',1.5)
...
plot(rmsfe_post_mod4(1:end),'LineWidth',1.5)
plot(rmsfe_post_mod5(1:end),'LineWidth',1.5)
xticks([1,4,8,12,15,18])
ylim([0.5 7])
xlim([0 22])
xticklabels({'135','115','95','75','55','35'})
...
plot(rtcrps_pre_mod4(1:end),'LineWidth',1.5)
plot(rtcrps_pre_mod5(1:end),'LineWidth',1.5)
xticks([1,4,8,12,15,18])
ylim([0.10 0.25])
xlim([0 22])
xticklabels({'135','115','95','75','55','35'})
...
plot(rtcrps_post_mod4(1:end),'LineWidth',1.5)
plot(rtcrps_post_mod5(1:end),'LineWidth',1.5)
xticks([1,4,8,12,15,18])
ylim([0 3])
xlim([0 22])
xticklabels({'135','115','95','75','55','35'})
...
hL =  legend('KP (2023)','Trend(HS)-SV(HS)-GIGG','Trend(HS)-SV(HS)-t-GIGG','Trend(HS,no g)-SV(HS)-t-GIGG','KP (2023) - hierarchical');
...
figname = ['/Users/dk/Documents/GitHub/Bayesian-MIDAS/Output/eval_nowcasting.pdf'];
saveas(han,figname)
saveas(han,['/Users/dk/Documents/GitHub/Bayesian-MIDAS/Output/eval_nowcasting.fig'])
