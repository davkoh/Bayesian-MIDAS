function [output_dyn_hs_trend] = sample_dyn_hs_trend_v3(ystar,input_dyn_hs_trend)
...
% normal mixture
        ...
        phi_temp = slice_sampling_v2(phi_temp, log_likelihood,y_ar,x_ar, 0, 1); % Adjust upper and lower bounds as needed
        phi = 2*phi_temp -1;
    ...
    %% 2: Sample State variables
        ...
        Ktau= (speye(T)*1./sig2_y + H'*iSig_tau*H);
        Ctau = chol(Ktau,'lower');
        tau_hat = Ktau\(speye(T)*1./sig2_y*y);
