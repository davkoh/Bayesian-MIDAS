...
% case study
% TODO: make this a wrapper function for "dynamic horseshoe" in the trend
...
rate1 = 1; % recommendation of the paper
rate2 = 3; % recommendation of the paper
